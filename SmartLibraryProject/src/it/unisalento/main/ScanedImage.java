...
public class ScanedImage { 
	...
	{ 
		...
		ImageIO 
			.write(fopimage, 
				"jpg", 
				new File("C:\\Users\\marco\\git\\SmartLibrary\\SmartLibraryProject\\pictures\\output.jpg")); 

		// Instantiating the Tesseract class 
		// which is used to perform OCR 
		Tesseract it = new Tesseract(); 

		it.setDatapath("C:\\Users\\marco\\git\\SmartLibrary\\SmartLibraryProject\\Tess4J"); 
	...
	{ 
		File f 
			= new File( 
				"C:\\Users\\marco\\git\\SmartLibrary\\SmartLibraryProject\\pictures\\prova.jpg"); 
